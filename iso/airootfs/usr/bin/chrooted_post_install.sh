...
_common_systemd() {
    local _systemd_enable=(NetworkManager cups avahi-daemon systemd-timesyncd lightdm-plymouth)   
...
_clean_archiso() {
    ...
    local _files_to_remove=(
		...
		/usr/bin/{post_install.sh,chrooted_post_install.sh}
...
_fix_grub_stuff() {
    _run_if_exists_or_complain archcraft-hooks-runner
